export const en = {
  ...
  cityHome: {
    ...
    actions: {
      ...
      openAnalytics: 'Full statistics',
    },
    analyticsTeaser: {
      title: 'City statistics',
      description:
        'A quick snapshot of city requests. See the statistics page for details.',
    },
    rolePanel: {
  ...
  analytics: {
    cityTitle: 'City statistics',
    adminTitle: 'System analytics',
    tabs: {
      requests: 'Requests',
      surveys: 'Surveys',
      alerts: 'Announcements',
    ...
    heatmap: {
      ...
      description:
        'Density of resident requests on the map — where problems arise most often.',
      loading: 'Loading map…',
      error: 'Failed to load map',
      empty: 'No requests with coordinates.',
    },
    enums: {
      OPEN: 'Open',
      IN_PROGRESS: 'In progress',
    ...
    labels: {
      requests: {
        ...
        timeline: 'Submitted vs resolved over time',
        submitted: 'Submitted',
        resolved: 'Resolved',
        byDepartment: 'Workload by department',
      ...
      surveys: {
        participation: 'Votes per survey',
        votes: 'Votes',
        votesTimeline: 'Voting over time',
        total: 'Total surveys',
        open: 'Active',
      ...
      alerts: {
        ...
        timeline: 'Announcements over time',
        count: 'Count',
      ...
      system: {
        ...
        newUsers: 'New users',
        cityFunnel: 'City creation requests',
        citiesByRegion: 'Cities by region',
        cities: 'Cities',
        topCities: 'Most active cities',
        activity: 'Activity',
        users: 'Users',
