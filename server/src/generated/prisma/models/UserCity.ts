...
export type UserCityWhereInput = {
  ...
  joinedAt?: Prisma.DateTimeFilter<"UserCity"> | Date | string
...
export type UserCityScalarWhereWithAggregatesInput = {
  ...
  joinedAt?: Prisma.DateTimeWithAggregatesFilter<"UserCity"> | Date | string
}
...
export type UserCityOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "cityId" | "joinedAt", ExtArgs["result"]["userCity"]>
...
export interface UserCityFieldRefs {
  ...
  readonly joinedAt: Prisma.FieldRef<"UserCity", 'DateTime'>
}
