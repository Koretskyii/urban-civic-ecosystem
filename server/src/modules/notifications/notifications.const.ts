...
export const EVENT_TYPE_TO_EMAIL_ENABLED: Record<DomainEventType, boolean> = {
  [DOMAIN_EVENT_TYPES.NEWS_CREATED]: false,
  [DOMAIN_EVENT_TYPES.NEWS_UPDATED]: false,
  [DOMAIN_EVENT_TYPES.NEWS_DELETED]: false,
  [DOMAIN_EVENT_TYPES.ALERT_CREATED]: true,
  [DOMAIN_EVENT_TYPES.ALERT_UPDATED]: false,
  [DOMAIN_EVENT_TYPES.ALERT_DELETED]: false,
  [DOMAIN_EVENT_TYPES.CITY_REQUEST_CREATED]: true,
  [DOMAIN_EVENT_TYPES.CITY_REQUEST_ASSIGNED]: true,
